...
export type RestaurantMenusCategories = {
    id: number;
    name: string;
    items: RestaurantMenusCategoriesItems[];
}
export type RestaurantMenus = {
    _id: RestaurantMenusId;
    restaurants_id: RestaurantMenusRestaurantsId;
    id: number;
    name: string;
    type: number;
    restu_url: string;
    categories: RestaurantMenusCategories[];
}
...
export type RestaurantDailyMenus = {
    _id: RestaurantDailyMenusId;
    restaurants_id: RestaurantDailyMenusRestaurantsId;
    date: string;
    items: RestaurantDailyMenusItems[];
}
export type Restaurant = {
    ...
    cover_photo: RestaurantCoverPhoto;
    id: number;
    gps_lat: number;
    gps_lon: number;
    verified: boolean;
    ...
    daily_menus: RestaurantDailyMenus[];
};
