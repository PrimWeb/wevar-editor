import { TextH3 }               from "@/components/selectors/TextH3";
...
export const Toolbox = ({props}) => {
    ...
    >
        <div className="flex flex-1 flex-col items-center pt-3">
            ...
            <div ref={(ref) => create(ref, <TextH3 fontSize="22" textAlign="center" text="Menu nadpis"/>)}>
                <Tooltip title="TextH3" placement="right">
                    <Item className="m-2 pb-2 cursor-pointer block" move>
                        <TypeSvg/>
                    </Item>
                </Tooltip>
            ...
            <div
                ref={(ref) => create(ref, <Text fontSize="12" textAlign="left" text="Základní text - popis, atp..."/>)}>
